...
public class FirstTest {
    ...
    public void testUntitledTestCase() throws Exception {
        ...
        driver.get("https://sandbox.cardpay.com/MI/payment.html?uuid=DGe2h7dE5GBab7a340hGdggB");
        ...
        driver.findElement(By.id("input-card-holder")).sendKeys("ARSENII ALESHKOV");
